<script type="text/javascript">
	function fnClickServiceTransaction(){
		document.serTransactionInfoInForm.submit();
	}
...
<div class="container">
	<div class="panel panel-default">
		<div class="panel-body">
			<form action="serviceTransaction/ServiceTrasactionSubmit.php" id="serTransactionInfoInForm" method="post" name="serTransactionInfoInForm" METHOD="POST">
				...
				<div class="form-group row">
					...
					<div class="col-sm-4">
						<button onclick="fnClickServiceTransaction();" type="button" class="btn btn-default">Process</button>
					</div>
				</div>
			</form>
		</div>
